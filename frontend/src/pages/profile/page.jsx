            ...
            <div className='flex flex-col gap-16 mt-10 w-full'>
              <div className='flex flex-col gap-3'>
                ...
                <Text size='sm' faded copy>
                  ...
                  Corp. When I'm not building robots that can dance
                  (seriously!), I'm leading our amazing team of engineers to
                  solve the world's toughest problems. We thrive on creativity,
                  collaboration, and a healthy dose of caffeine (and puns). If
                  you're an engineer who loves tackling challenges with a smile,
